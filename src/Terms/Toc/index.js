	...
	<Fragment>
		...
		<Section>
			<pre>
				<code>
					{`
<b>This Agreement</b> (the "Agreement" or the "Terms") is effective as of: July 31, 2018 and describes the terms on which Musicoin Foundation ("MCF") offers you access to an Account and services. 
...
2.3 You acknowledge that you are granting MCF licenses to use your Content.
...
2.4 You acknowledge that you are granting Content licenses to other users by submitting your Content to publicly accessible areas of the Service.
...
2.5 You may choose to delete copies of your Content from the Service, and the licenses to your Content will terminate with certain limitations.
...
2.6 You understand and agree to respect the Intellectual Property Rights of MCF, other users and third parties.
...
3.1 You must establish an account to use certain aspects of the Service, using true and accurate registration information.
...
3.2 Eligibility for Use of the Service.
...
3.3 You agree to use a non-misleading, non-offensive and non-infringing Account Name. 
...
4.1 You or we may terminate your Account(s) at any time.
...
4.2 We may terminate your Accounts for violation of this Agreement. 
...
4.3 We may terminate your Account(s) to protect the best interests of the Service and the community.
...
4.4 We may terminate your Accounts upon a general suspension or discontinuation of the Service.
...
4.5 Upon Account termination, you will lose access to your Account and all licenses, Content, and data, and you understand this is a risk of participating in the Service.
...
4.6 Certain terms in this Agreement will survive after termination.
...
5. INFRINGEMENT NOTIFICATION POLICY
...
7. RELEASES, DISCLAIMERS, LIMITATIONS OF LIABILITY AND INDEMNIFICATION
7.1 MCF is NOT liable for its users' actions.
...
7.2 MCF provides the Service on an "as is" basis, without express or implied warranties, and all Content, has no guarantee or warranty of any compensable value.
...
7.3 MCFs liability to you is expressly limited, to the extent allowable under applicable law.
...
7.4 You agree to indemnify MCF from claims relating to your use of the Service.
...
8.1 If a dispute arises between you and MCF regarding a claim, you and we agree to alternative dispute resolution. 
...
8.2 Exceptions to Arbitration Requirement. 
...
9.1 You may not assign this Agreement or your Account; we may assign this Agreement.
...
9.2 We agree to provide each other with notices in a specified manner.
...
9.3 You acknowledge this Agreement and the referenced Policies are the entire understanding between us.
