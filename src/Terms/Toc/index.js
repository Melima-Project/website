...
export const Tos = () => (
	<Fragment>
		...
		<p>
<b>This Agreement</b> (the "Agreement" or the "Terms") <b>is effective as of: July 31, 2018</b> and describes the terms on which Musicoin Foundation ("MCF") offers you access to an Account and services. 
...
</MoreInfo><MoreInfo title="2. INTELLECTUAL PROPERTY RIGHTS">
...
</MoreInfo><MoreInfo title="3. CONTENT LICENSES">
...
</MoreInfo><MoreInfo title="4. ACCOUNT REGISTRATION">
...
</MoreInfo><MoreInfo title="5. ACCOUNT TERMINATION">
...
</MoreInfo><MoreInfo title="6. INFRINGEMENT NOTIFICATION POLICY">
...
</MoreInfo><MoreInfo title="7. PRIVACY POLICY">
...
</MoreInfo><MoreInfo title="8. RELEASES, DISCLAIMERS, LIMITATIONS OF LIABILITY AND INDEMNIFICATION">
...
</MoreInfo><MoreInfo title="9. DISPUTE RESOLUTION AND ARBITRATION">
...
</MoreInfo><MoreInfo title="10. GENERAL PROVISIONS">
	...
	<Fragment>
		...
		<Section>
			<pre>
				<code>
					{`
This USER GENERATED AND ARTIST CONTENT POLICY is effective as of July 31, 2018 and applies to all Accounts and Content shared or streamed using the Service as such terms are defined in the Terms of Service Agreement (“Terms”).
...
1.2 Our Service is designed to provide the crypto currency Musicoin ($MUSIC) as compensation in exchange for their exclusive rights under copyright laws.
...
“Account Holder” means a person who has established an Account on the Site, as both are defined under the Terms, and contributes Promoted Content and or streams tracks using the Service this includes both User and Artist Account Holders. 

“Artist Account Holders” means Artists, as defined under the Terms, namely verified creators with the ability to upload tracks and other related Artist Content to the Service. If Artist consists of multiple persons, then all references to singular “Artist” are intended to refer and apply to all such persons and each person comprising Artist as defined under the Terms.
...
"Pay Per Play License" means the price paid by the Service to Artist upon streaming a Track through on the Site including via link on a Promoted Channel.
...
“Site” means www.musicoin.org.

2. Artist provides certain warranties to MCF regarding the Content submitted to the Service.
...
3. Artist grants to MCF and its Account Holders certain licenses and rights to Artist Content.
...
5. Pay-Per-Play (PPP) protocol represents a legal license to perform tracks using the Service and includes license payment terms.
...
6. Artist Indemnity of MCF, Disclaimers and Limitations of Liability
...
7. The Artist Account may be terminated by the Artist or by MCF.
...
Account Holders may terminate their Account for any reason by submitting a request for termination seven (7) days prior written notice to MCF to the email address support@musicoin.org. Termination of an Account also terminates access to the digital wallet address corresponding to that Account. 
...
8. Confidentiality and use of Certain Information.
...
10. Assignment, Amendments, Conflicts 
...
11. The Artist Content Policy, together with MCF's Privacy Policy and Terms of Service (as the same may be amended from time to time), constitute the entire Agreement between MCF and Artist.
...
11.3 All notices permitted or required under this Agreement must be in writing.

Notices other than for technical support which are being sent to MCF relating to this Artist policy or our agreement must be addressed to MCF at support@musicoin.org cc: legal@musicoin.org.
...
Information that will enable us to identify the work claimed to be infringed or, if multiple works are claimed to be infringed, a representative list of such works (for example: title, author, any registration or tracking number, URL);
Information that will enable us to identify and locate the material that is claimed to be infringing (for example a link to the page that contains the material);
...
2. Your complete information, including your full name, mailing address, telephone number, and email address;
3. A description of the intellectual property that you claim has been infringed and a copy of the corresponding USPTO registration;
4. Information reasonably sufficient to permit us to locate the specific allegedly infringing material on our site, including the URL where the content appears, or other means of identifying the allegedly infringing content with particularity;
5. A statement that you have a good faith belief that use of the material in the manner asserted is not authorized by the owner of the intellectual property, its agent, or the law;
6. A statement under penalty of perjury, that all the information in your notice is accurate, and that you are the owner of the intellectual property at issue (or, if you are not the owner, then your statement must indicate that you are authorized to act on the behalf of the owner of the intellectual property); and,
7. Your physical or electronic signature (typing your full name will serve as your electronic signature).
